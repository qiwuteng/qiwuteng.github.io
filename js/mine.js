...
var cartoon_gif = '<i class="fas fa-arrow-up" style ="padding:10px" ></i><img style="max-width: 234%;transform: translate(-75px,-75px);" src="https://raw.githubusercontent.com/qiwuteng/blog-data0/main/cartoon_gif/xinkule.gif" title="回到顶部" data-ll-status="loaded" class="loaded">';
/*添加到返回顶部按钮下*/
